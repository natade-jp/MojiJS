...

{
	...
	test("encode 1-1", () => { expect(equalsArray(Encode.encode(text, "utf-8"), utf_8)).toBe(true); });
	test("encode 1-2", () => { expect(equalsArray(Encode.encode(text, "utf-8", true), utf_8_bom)).toBe(true); });
	test("encode 1-3", () => { expect(equalsArray(Encode.encode(text, "utf-16le"), utf_16le)).toBe(true); });
	test("encode 1-4", () => { expect(equalsArray(Encode.encode(text, "utf-16be"), utf_16be)).toBe(true); });
	test("encode 1-5", () => { expect(equalsArray(Encode.encode(text, "utf-32le"), utf_32le)).toBe(true); });
	test("encode 1-6", () => { expect(equalsArray(Encode.encode(text, "utf-32be"), utf_32be)).toBe(true); });
...

{
	...
	test("encode 4-1", () => { expect(equalsArray(Encode.encode(text, "EUC-JP"), eucjp)).toBe(true); });
	test("decode 4-1", () => { expect(Encode.decode(eucjp, "EUC-JP")).toBe(text); });
}
