...

{
	...
	test("fromSJIS2004Array 1", () => { expect(SJIS2004.fromSJIS2004Array(sjis2004).encode_string).toBe(text); });
}
{
	const text		= "謹𪘂麵";
	...
	test("fromSJIS2004Array 2", () => { expect(SJIS2004.fromSJIS2004Array(sjis2004).encode_string).toBe(text); });
}
